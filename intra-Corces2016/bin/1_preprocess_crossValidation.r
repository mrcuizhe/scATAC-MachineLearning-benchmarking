setwd("/scATAC-machineLearning-benchmarking/intra-Corces2016/bin")
...
saveRDS(data,file="../output/corces2016-snap-full.rds")

# label<-label[order(label[,1]),]

# write.table(label,file="../input/metadata_10xpbmc_sorted.tsv",quote=FALSE,sep="\t",row.names = FALSE)
