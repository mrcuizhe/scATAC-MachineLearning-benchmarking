setwd("/scATAC-machineLearning-benchmarking/intra-10xPBMCsNextGem/bin")
...
# write.table(label,file="../input/pbmc_5k_atac_label_nextgem.txt",quote=FALSE,sep="\t",row.names = FALSE)
