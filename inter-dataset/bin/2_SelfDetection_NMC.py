...
def run_NMC(trainDataPath,testDataPath, trainLabelsPath,testLabelsPath, CV_RDataPath, OutputDir):
    '''
    run baseline classifier: NMC
    Wrapper script to run an NMC classifier on a benchmark dataset with 5-fold cross validation,
...
run_NMC("../input/10xpbmc5k-snap-full_v1Train.rds","../input/10xpbmc5k-snap-full_nextgemTest.rds", "../input/pbmc_5k_atac_label_v1.txt","../input/pbmc_5k_atac_label_nextgem.txt", "../tmp/CV_folds_v1Train_nextgemTest.RData", "../output")
