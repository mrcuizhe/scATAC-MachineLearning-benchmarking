...
run_SVM("../input/10xpbmc5k-snap-full_v1Train.rds","../input/10xpbmc5k-snap-full_nextgemTest.rds", "../input/pbmc_5k_atac_label_v1.txt","../input/pbmc_5k_atac_label_nextgem.txt", "../tmp/CV_folds_v1Train_nextgemTest.RData", "../output")
