...
def run_KNN50(DataPath, LabelsPath, CV_RDataPath, OutputDir):
    '''
...
run_KNN50("../output/buenrostro2018-snap-full.rds", "../input/metadata_buenrostro2018_sorted.tsv", "../tmp/CV_folds.RData", "../output/")
