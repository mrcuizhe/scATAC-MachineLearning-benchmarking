...
def run_KNN9(DataPath, LabelsPath, CV_RDataPath, OutputDir):
    '''
...
run_KNN9("../output/buenrostro2018-snap-full.rds", "../input/metadata_buenrostro2018_sorted.tsv", "../tmp/CV_folds.RData", "../output/")
